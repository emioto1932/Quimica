...
<tr><td>Configuração Eletrônica (K L M N O P Q)</td><td>${elementoAtual.configuracaoEletronica}</td><td><a href="objeto.html?propriedade=densidade&grupo=${grupoSelecionado}&elemento=${elementoAtual.nome}" class="popup-link">Abrir Tabela de Densidade</a></td><td>${exibirComVirgula(elementoAtual.densidade)}</td></tr> 
