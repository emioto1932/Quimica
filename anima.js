...
elementSelect.addEventListener("change", () => { 
  ...
  tableBody.innerHTML = ` 
    ...
    <tr><td><a href="objeto.html?propriedade=protons">Número atômico ou Número de Prótons (carga +)</a></td><td>${elementoAtual.protons}</td><td>Categoria</td><td>${elementoAtual.categoria}</td></tr> 
