...
elementSelect.addEventListener("change", () => { 
  ...
  tableBody.innerHTML = ` 
   ...
   <tr><td>Configuração Eletrônica (K L M N O P Q)</td><td>${elementoAtual.configuracaoEletronica}</td><td><a href="javascript:void(0);" onclick="openPopup('densidade')">Abrir Tabela de Densidade</a></td><td>${exibirComVirgula(elementoAtual.densidade)}</td></tr> 
