...
<tr><td>Configuração Eletrônica (K L M N O P Q)</td><td>${elementoAtual.configuracaoEletronica}</td><td><a href="objeto.html?propriedade=densidade&grupo=${encodeURIComponent(grupoSelecionado)}&elemento=${encodeURIComponent(elementoAtual.nome)}">Abrir Tabela de Densidade</a></td><td>${exibirComVirgula(elementoAtual.densidade)}</td></tr> 
